...
def make_data_module(tokenizer: transformers.PreTrainedTokenizer, args) -> Dict:
    ...
    def format_dataset(dataset, dataset_format):
        ...
        elif dataset_format == "Taiwan_LLM_chat":
            print("Formatting Taiwan_LLM_chat dataset")
            dataset = dataset.map(lambda x: {"input": get_prompt(x["instruction"]), "output": x["output"]})
